...
FILENAME_CONTROLNET = Path(__file__).parents[1] / "weights/sd-controlnet-hed.bin"
...
if __name__ == "__main__":
  ...
  download_file(
    'https://huggingface.co/lllyasviel/sd-controlnet-hed/resolve/main/diffusion_pytorch_model.bin', FILENAME_CONTROLNET)
  state_dict_controlnet = torch_load(FILENAME_CONTROLNET)
  controlnet = ControlNetModelHED(cross_attention_dim=768)
